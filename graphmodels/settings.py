# Django settings for graphmodels project.
import os.path
import socket
...
USR_RESULT_ROOT = os.path.join(os.path.dirname(__file__), 'files/result/').replace('\\', '/')
USR_RESULT_URL = '/files/result/'

IMAGE_ROOT = os.path.join(os.path.dirname(__file__), 'images/').replace('\\', '/')
IMAGE_URL = '/images/'
...
SECRET_KEY = 'gc6vfd38prk**lvh)wrxswjtbr3)0s37fmfb1@pt1+y4vh32wi'
...
EMAIL_HOST_USER = 'jiangfeng1124@hotmail.com'
EMAIL_HOST_PASSWORD = 'jiangfengjiaji'
EMAIL_PORT = 587
